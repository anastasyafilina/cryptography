...
cyrillic_alphabet_backwords = ['Я', 'Ю', 'Э', 'Ь', 'Ы', 'Ъ', 'Щ', 'Ш', 'Ч', 'Ц', 'Х', 'Ф', 'У', 'Т', 'С', 'Р', 'П', 'О', 'Н', 'М', 'Л', 'К', 'Й', 'И', 'З', 'Ж', 'Е', 'Д', 'Г', 'В', 'Б', 'А']
shifr_k_numbers=[]
encrypted_str=""
...
for element in initinal_str:
    if element in cyrillic_alphabet_backwords:
        letter=element
        letter_index=cyrillic_alphabet_backwords.index(letter)+1
        ...
        if i==len(shifr_k_numbers):
            i=0
        letter_encrypted=cyrillic_alphabet_backwords[letter_index_encrypted-1]
